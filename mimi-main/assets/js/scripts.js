...
(function ($) {
  ...
  $(".tk_countdown_time").each(function () {
    ...
    $(this).countdown(endTime, function (tm) {
      $(this).html(
        tm.strftime(
          '<span class="counter_box"><span id="days" class="tk_counter days">%D </span><span class="tk_text">Days</span></span><span class="counter_box"><span id="hours" class="tk_counter hours">%H</span><span class="tk_text">Hours</span></span><span class="counter_box"><span id="mins" class="tk_counter minutes">%M</span><span class="tk_text">Minutes</span></span><span class="counter_box"><span id="secs" class="tk_counter seconds">%S</span><span class="tk_text">Seconds</span></span>'
        )
      );
    });
  });
...
const oxygen = document.querySelector(".oxygen-pic");
const spans = document.querySelectorAll(".spans");
const colService = document.querySelectorAll(".col-service");
...
tl.fromTo(
  ...
  .fromTo(oxygen, 2, {}, { ease: Power2.easeInOut })
  .fromTo(
    spans,
    1,
    { color: "darkpurple" },
